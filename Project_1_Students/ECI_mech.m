function [P_out, V_out, A_out] = ECI_mech(constants, P_in, V_in, A_in, w_b__i_b_tilde, f_b__i_b_tilde, fidelity)
...
switch fidelity
   case 'Low'
    ...
    case 'High'
        ...
        dTheta = norm(w_b__i_b_tilde * dt);
        k = w_b__i_b_tilde / norm(w_b__i_b_tilde);
        K = vec2ss(k);
