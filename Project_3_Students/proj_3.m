...
load_constants3;                     % Load a file of constants
...
%==========================================================================
%% Part I. Generate the ground truth data
%==========================================================================
...
% L_t       = 30 + 0 * t_sec; % Geodetic Latitude  of radar tracking frame (rad)
% lambda_t  = -135 + 0 * t_sec; % Geodetic Longitude of radar tracking frame (rad)
% h_t       = 15 + 0 * t_sec;         % Geodetic height    of radar tracking frame (m)
...
%==========================================================================
%% Part II. ECEF Mechanization (Ground Truth - Error Free)
%==========================================================================
